    ...
    private void populateUI(Sandwich sandwich) {
        ...
        if (ingredientsList.isEmpty()) {
            ...
            for (int i = 0; i < ingredientsList.size(); i++) {
                ingredientsBuilder
                        .append("\u2022 ") // for Bullet point
                        .append(ingredientsList.get(i));
                // for no line break after last ingredient
        ...
        if (alsoKnownAsList.isEmpty()) {
            ...
            StringBuilder dpakBuilder = new StringBuilder();
            for (int i = 0; i < alsoKnownAsList.size(); i++) {
                dpakBuilder
                        .append("\u2022 ") // for bullet point
                        .append(alsoKnownAsList.get(i));
                // for no line break after last
                if (i != alsoKnownAsList.size() - 1)
                    dpakBuilder.append('\n');
            }
            alsoKnownAs = dpakBuilder.toString();
        }
